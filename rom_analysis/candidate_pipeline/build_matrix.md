...
| `softgate-dev-combined` | 8 strings | `fceux_input_explorer_v042 frame 883 dialogue screen` | `multiple` | 1 | cumulative equal-length PRG bytes + existing font expansion | PASS | PASS | soft gate only | cumulative dev candidate produced |
