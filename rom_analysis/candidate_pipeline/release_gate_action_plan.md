...
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 10 | release-included visual proof | FAIL | VISUAL_PROOF_PENDING | `primary_v042_visual_review` | `0x0569D` | visible-screen capture and primary visual review confirmation | `python scripts/record_primary_visual_review.py 0x0569D --confirm --screen-context "look for a bridge/stage/location label visible"` |
...
| 30 | shortened padding rule acceptance | UNKNOWN | PADDING_RULE_UNPROVEN | `padding_rule_acceptance` | `ROM+0x071A4 Chikara -> 힘` | strict PPU/visual acceptance for one of 5 v05 padding strategies; start with preserve_tail | `python scripts/audit_padding_experiment_pipeline.py` |
