...
Input directory: `rom_analysis\fceux_padding_exp_pad_00_watch`
...
- Total read hits: `11`
- Callback detail: `callback_mode=true;target_source=kunio_padding_exp_pad_00_targets.lua;targets=1`
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `padding_pad_00_rom_071a4_candidate_82` | 능력치 | `ROM+0x071A4` | `$B192-$B19C` | 11 | 358 | 376 | 11 | 11 | yes | `82 00 9F B4 87 00 00 A6` |

## Details

| label | top CPU addresses | top values | expected bytes | top byte diff | record snapshot evidence |
| --- | --- | --- | --- | --- | --- |
| `padding_pad_00_rom_071a4_candidate_82` | `$B192`:1, `$B193`:1, `$B194`:1, `$B195`:1 | `00`:3, `9F`:1, `B4`:1, `87`:1 | `87 00 00` | `` | `yes: 9F B4 87 00 00 A6 83 CA F8 F9 00` |
