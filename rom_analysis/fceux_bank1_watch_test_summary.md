...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `soubi_ui_c` | ui | `ROM+0x06FA1` | `$AF91-$AF9A` | 236 | 604 | 802 | 10 | 0 | no | `7F 43 CA 02 C4 46 C5 FF` |
| `chikara_stat_e` | stat | `ROM+0x071A4` | `$B192-$B19C` | 11 | 358 | 376 | 11 | 11 | yes | `82 00 9F B4 93 88 AA A6` |

## Details

| label | top CPU addresses | top values | expected bytes | record snapshot evidence |
| --- | --- | --- | --- | --- |
| `soubi_ui_c` | `$AF95`:46, `$AF96`:46, `$AF97`:46, `$AF98`:44 | `C5`:46, `FF`:46, `01`:46, `CE`:44 | `9C 90 A8` | `no: CA 02 C4 46 C5 FF 01 CE 3C 95` |
| `chikara_stat_e` | `$B192`:1, `$B193`:1, `$B194`:1, `$B195`:1 | `9F`:1, `B4`:1, `93`:1, `88`:1 | `93 88 AA` | `yes: 9F B4 93 88 AA A6 83 CA F8 F9 00` |
