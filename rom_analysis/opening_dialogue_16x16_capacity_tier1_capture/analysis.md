...
- Visual note: Native frame 883 review: all 13 paired 16x16 syllables render distinctly; the expanded 0x81-0x9A source range shows no visible opening-scene background or UI damage. The compact wording remains a capacity probe, not release text.
