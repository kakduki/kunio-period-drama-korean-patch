...
| --- | --- | --- | --- | ---: | --- | --- | --- |
| high | へいしち | 헤이시치 | `0x06294` | 1 | `9D 82 8C 91` | 헤이시치 | - |
| high | へいしち | 헤이시치 | `0x06359` | 1 | `9D 82 8C 91` | 헤이시치 | - |
| high | へいしち | 헤이시치 | `0x0631B` | 1 | `9D 82 8C 91` | 헤이시치 | - |
| medium | たつじ | 타츠지 | `0x052A5` | 1 | `82 84 7E` | 타츠지 | 지 |
| medium | かじや | 대장간 | `0x0440C` | 1 | `CA D0 E9` | 대장간 | 대간 |
| medium | たつじ | 타츠지 | `0x05BE5` | 1 | `97 99 93` | 타츠지 | 지 |
| medium | たつじ | 타츠지 | `0x048F4` | 1 | `07 09 03` | 타츠지 | 지 |
...
| たつじ | 타츠지 | `0x131D8` | `00 02 FC` | not Bank 1; source bytes contain control-like values; capture priority 60 is not high enough for promotion; confidence 'low' is not high/medium |
| じごく | 지옥 | `0x10E68` | `04 02 00` | not Bank 1; source bytes contain control-like values; length mismatch source_bytes=3 korean_glyphs=2; capture priority 60 is not high enough for promotion; confidence 'low' is not high/medium |
| じごく | 지옥 | `0x0D339` | `08 06 04` | not Bank 1; length mismatch source_bytes=3 korean_glyphs=2; capture priority 60 is not high enough for promotion; confidence 'low' is not high/medium |
