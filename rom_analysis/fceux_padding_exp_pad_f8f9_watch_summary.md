...
Input directory: `rom_analysis\fceux_padding_exp_pad_f8f9_watch`

Command:

```powershell
python scripts\run_fceux_lua_analysis.py --rom output\kunio_period_drama_korean_prg_padding_exp_rom_071a4_candidate_82_pad_f8f9.nes --lua-script lua\kunio_bank1_watch.lua --target-lua lua\kunio_padding_exp_pad_f8f9_targets.lua --frames 3600 --timeout 120 --final-output rom_analysis\fceux_padding_exp_pad_f8f9_watch --clean-output --no-dump-hex --no-dump-bin
```
...
- Total read hits: `9`
- Callback detail: `callback_mode=true;target_source=kunio_padding_exp_pad_f8f9_targets.lua;targets=1`
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `padding_pad_f8f9_rom_071a4_candidate_82` | 능력치 | `ROM+0x071A4` | `$B192-$B19C` | 9 | 358 | 372 | 9 | 9 | yes | `82 00 9F B4 87 F8 F9 A6` |

## Details

| label | top CPU addresses | top values | expected bytes | top byte diff | record snapshot evidence |
| --- | --- | --- | --- | --- | --- |
| `padding_pad_f8f9_rom_071a4_candidate_82` | `$B192`:1, `$B193`:1, `$B194`:1, `$B195`:1 | `F8`:2, `9F`:1, `B4`:1, `87`:1 | `87 F8 F9` | `` | `yes: 9F B4 87 F8 F9 A6 83 CA F8 F9 00` |
