...
- Semantically reviewed rows: `128` / `244`.
- Translation statuses: `{'english_reference_reviewed': 128, 'english_semantic_draft': 116, 'excluded_non_dialogue': 4}`.
- Failures: `{}`.
- Warnings: `{'context_confirmation_required': 113, 'dynamic_control_context': 27, 'semantic_draft_not_reviewed': 116}`.
