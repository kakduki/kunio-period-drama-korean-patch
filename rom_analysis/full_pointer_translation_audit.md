...
- Semantically reviewed rows: `15` / `244`.
- Translation statuses: `{'english_reference_reviewed': 15, 'english_semantic_draft': 229, 'excluded_non_dialogue': 4}`.
- Failures: `{}`.
- Warnings: `{'context_confirmation_required': 223, 'semantic_draft_not_reviewed': 229}`.
