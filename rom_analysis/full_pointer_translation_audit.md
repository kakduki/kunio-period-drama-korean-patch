...
- Semantically reviewed rows: `83` / `244`.
- Translation statuses: `{'english_reference_reviewed': 83, 'english_semantic_draft': 161, 'excluded_non_dialogue': 4}`.
- Failures: `{}`.
- Warnings: `{'context_confirmation_required': 158, 'dynamic_control_context': 27, 'semantic_draft_not_reviewed': 161}`.
