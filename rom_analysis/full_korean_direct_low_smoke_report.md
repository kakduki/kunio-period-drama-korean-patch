...
- Menu capture: `rom_analysis\main_menu_full_direct_low_candidate_capture`.
- Progression capture: `rom_analysis\stage_progression_probe_full_direct_low_candidate`.
