...
| Full translated script | CANDIDATE_BUILT | 244 Korean rows compile with preserved English non-letter control skeletons; 38 rows are English-reference reviewed, 206 semantic drafts remain, 27 dynamic-control records need context review, and four excluded rows retain Japanese bytes. |
