...
| full_pointer_korean_candidate | pointers `0-247`; packed records `0x05FC4-0x06EF1`; 49 appended CHR pages | all active records preserve English non-letter control skeletons; width audit max `24/24`; 15 rows reviewed; 4 excluded rows retain Japanese bytes | forced pointers 0/25/50/100/181 PASS across pages 11/16/39/46/42; state, R1, source, terminator PASS | Korean text pixels and field background PASS on all 5 samples | WHOLE_SCRIPT_RUNTIME_PASS_5_PAGES |
...
`f6bbe666cc6e976b448c1713e85da65e`. It compiles 244 Korean dialogue rows,
including 15 English-reference-reviewed corrections, retains four excluded
...
event-control proof; 229 draft rows and broad visual coverage remain open.
