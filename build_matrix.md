...
| one_hit_ram_cheat_7A02_probe | RAM write `0x7A02`=00 during combat | External ref check + runtime `04F1`/`FAD9`/`FC82`/`FCEF` monitoring | Mixed=13, stationary=38, grid=11 unique screens, all `lua_done` | no later dialogue; no boss context transition captured | CHEAT_EFFECT_OBSERVED_BOSS_ROUTE_UNKNOWN |
...
## Pre-Pointer High-Code Candidate (2026-08-01)
