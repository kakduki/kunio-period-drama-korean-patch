...
KEY_PYTHON = [
    ...
    "scripts/generate_translation_coverage_bridge.py",
    ...
    "scripts/test_translation_coverage_bridge.py",
    ...
    "scripts/test_kunio_stage_progression_probe.py",
...
LUA_SCRIPTS = [
    ...
    "lua/kunio_manifest_renderer_context_trace.lua",
    "lua/kunio_full_pointer_batch_renderer_trace.lua",
]
...
def main() -> int:
    ...
    run("stage progression counter-read probe", ["scripts/test_kunio_stage_progression_probe.py"])
