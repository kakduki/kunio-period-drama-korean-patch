...
KATANA_SINGLE_SLOT_0503_NOTES = REPO_ROOT / "rom_analysis" / "katana_single_slot_probe_0503_notes.md"
...
OBJECT_STATE_PAIR_PLAN_JSON = REPO_ROOT / "rom_analysis" / "object_state_pair_plan.json"
OBJECT_STATE_PAIR_PLAN_MD = REPO_ROOT / "rom_analysis" / "object_state_pair_plan.md"
OBJECT_STATE_PAIR_04F0_NOTES = REPO_ROOT / "rom_analysis" / "object_state_pair_probe_04f0_dialogue_late_notes.md"
...
CURRENT_PRIMARY_VISUAL_TASK_JSON = REPO_ROOT / "rom_analysis" / "current_primary_visual_task.json"
CURRENT_PRIMARY_VISUAL_TASK_MD = REPO_ROOT / "rom_analysis" / "current_primary_visual_task.md"
...
PADDING_STRATEGY_PRIORITY_GENERATOR = REPO_ROOT / "scripts" / "generate_padding_strategy_priority.py"
CURRENT_PRIMARY_VISUAL_TASK_GENERATOR = REPO_ROOT / "scripts" / "generate_current_primary_visual_task.py"
...
def write_release_readme(path: Path, summary: dict[str, object], ips_name: str) -> None:
    lines = [
        ...
        "- `object_state_pair_plan.md`: grouped object-state blocks for paired-write probes",
        ...
        "- `object_state_pair_probe_04f0_dialogue_late_notes.md`: result of testing the top `0x04F0` paired object-state fields",
...
def package() -> dict[str, object]:
    ...
    for src, name in [
        ...
        (KATANA_SINGLE_SLOT_0503_NOTES, "katana_single_slot_probe_0503_notes.md"),
        ...
        (OBJECT_STATE_PAIR_PLAN_MD, "object_state_pair_plan.md"),
        (OBJECT_STATE_PAIR_PLAN_JSON, "object_state_pair_plan.json"),
        ...
        (OBJECT_STATE_PAIR_04F0_NOTES, "object_state_pair_probe_04f0_dialogue_late_notes.md"),
        ...
        (CURRENT_PRIMARY_VISUAL_TASK_MD, "current_primary_visual_task.md"),
        (CURRENT_PRIMARY_VISUAL_TASK_JSON, "current_primary_visual_task.json"),
        ...
        (PADDING_STRATEGY_PRIORITY_GENERATOR, "generate_padding_strategy_priority.py"),
        (CURRENT_PRIMARY_VISUAL_TASK_GENERATOR, "generate_current_primary_visual_task.py"),
        ...
        (REPO_ROOT / "scripts" / "generate_object_state_pair_plan.py", "generate_object_state_pair_plan.py"),
