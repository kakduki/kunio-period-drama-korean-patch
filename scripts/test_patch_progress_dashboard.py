...
def main() -> int:
    ...
    expected = {
        ...
        "current_visual_task_decision": "NEEDS_MANUAL_VISUAL_PROOF",
        "current_visual_task_context_status": "CONTEXT_REJECTED_DIALOGUE_NOT_LOCATION_LABEL",
        "primary_auto_input_match_rows": 10,
        "v043_rows": 7,
        "manual_dump_record_files": 0,
        "padding_recommended_strategy": "preserve_tail",
        "padding_recommended_risk_class": "LOWEST_STRUCTURAL_RISK",
        "release_ready": False,
